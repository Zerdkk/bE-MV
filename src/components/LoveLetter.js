  ...
  return (
    <div className="love-letter">
      ...
      <div className="ode-poem">
        ...
        <div className="poem-line">My dear, we have just met,</div>
        <div className="poem-line">You've got to witness the sweetness of me,</div>
        <div className="poem-line">And me, the tenderness of you,</div>
        ...
        <div className="poem-line">Stay a little longer in my dreams,</div>
